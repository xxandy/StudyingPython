...
#  This program builds a cache of recently-accessed URLs, which
#  are kept ordered from oldest to newest, and made such that
#  time complecity is fairly close to O(1)
